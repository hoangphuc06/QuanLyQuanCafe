...
namespace QuanLyQuanCafe.DAO
{
    public class MenuDAO
    {
        ...
        public List<Menu> GetBillMenuByID(int id)
        {
            List<Menu> listMenu = new List<Menu>();
            
            string query = "SELECT f.NameFood, bi.count, f.Price, f.Price*bi.count AS TotalPrice FROM BillInfo AS bi, Food AS f, Bill AS b WHERE bi.ID_BillInfo = b.ID_Bill AND bi.ID_Food = f.ID_Food  AND b.ID_Bill = " + id.ToString();
