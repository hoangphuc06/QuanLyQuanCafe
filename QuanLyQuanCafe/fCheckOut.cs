...
namespace QuanLyQuanCafe
{
    public partial class fCheckOut : Form
    {
        ...
        private void btnAdd1k_Click_1(object sender, EventArgs e)
        {
            SumPrice += 1000;
            ExcessPrice = SumPrice - PayPrice;
            load();
        ...
        private void btnAdd2k_Click_1(object sender, EventArgs e)
        {
            SumPrice += 2000;
            ExcessPrice = SumPrice - PayPrice;
            load();
        ...
        private void btnAdd5k_Click_1(object sender, EventArgs e)
        {
            SumPrice += 5000;
            ExcessPrice = SumPrice - PayPrice;
            load();
        ...
        private void btnAdd10k_Click_1(object sender, EventArgs e)
        {
            SumPrice += 10000;
            ExcessPrice = SumPrice - PayPrice;
            load();
        ...
        private void btnAdd20k_Click_1(object sender, EventArgs e)
        {
            SumPrice += 20000;
            ExcessPrice = SumPrice - PayPrice;
            load();
        ...
        private void btnAdd50k_Click_1(object sender, EventArgs e)
        {
            SumPrice += 50000;
            ExcessPrice = SumPrice - PayPrice;
            load();
        ...
        private void btnAdd100k_Click_1(object sender, EventArgs e)
        {
            SumPrice += 100000;
            ExcessPrice = SumPrice - PayPrice;
            load();
        ...
        private void btnAdd200k_Click_1(object sender, EventArgs e)
        {
            SumPrice += 200000;
            ExcessPrice = SumPrice - PayPrice;
            load();
        ...
        private void btnAdd500k_Click_1(object sender, EventArgs e)
        {
            SumPrice += 500000;
            ExcessPrice = SumPrice - PayPrice;
            load();
